<?php include('config.php'); ?>
	...
	<div class="container" style="margin-top:20px">
		<center><font size="6">Edit Data Kategori</font></center>
		...
		if(isset($_POST['submit'])){
			...
			if($sql){
				echo '<script>alert("Berhasil menyimpan data."); document.location="dashbord.php?page=tampil_kategori";</script>';
			}else{
...
<form action="editkategori.php?id=<?php echo $id; ?>" method="post" enctype="multipart/form-data">
			<div class="item form-group">
				<label class="col-form-label col-md-3 col-sm-3 label-align">ID</label>
				<div class="col-md-6 col-sm-6">
					<input type="text" name="id_kategori" class="form-control" size="7" value="<?php echo $data['id_kategori']; ?>" readonly required>
				</div>
			</div>
			...
			<div class="item form-group">
				<div class="col-md-6 col-sm-6 offset-md-3">
					...
					<a href="dashbord.php?page=tampil_kategori" class="btn btn-warning">Kembali</a>
				</div>
			</div>
		</form>
	</div>
